...
public class SecurityUtils {
    ...
    public static User getCurrentUserObject() {
        ...
        user.setId("admin");
        user.setDisplayName("Bruce");
        user.setFirstName("Bruce");
        user.setLastName("Pan");
        user.setEmail("panda_han@outlook.com");
    ...
    public class FlowableAppUser extends org.springframework.security.core.userdetails.User {
        ...
        public FlowableAppUser(org.flowable.idm.api.User user, String userId, Collection<? extends GrantedAuthority> authorities) {
            super(userId, user.getPassword() != null ? user.getPassword() : "", authorities);
